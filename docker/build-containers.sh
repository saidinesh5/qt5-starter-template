...
docker build -f Dockerfile.linux64 -t qt5-build-environment-linux64 .
...
docker tag qt5-build-environment-linux64 docker.pkg.github.com/saidinesh5/qt5-starter-template/qt5-build-environment-linux64
